# Buddy LOS product build plan

| Product area | Native capability | State | Exit evidence |
|---|---|---|---|
| Public website | Positioning, product tour, trust and conversion | Foundation | Responsive browser verification |
| Identity | Supabase Auth with secure sessions | Planned | Sign-in, sign-out, expiry and revocation tests |
| Organizations | Tenant, membership and roles | Schema candidate | Cross-tenant denial tests |
