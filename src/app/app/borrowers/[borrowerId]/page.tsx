...
export default async function BorrowerPage({ params }: { params: Promise<{ borrowerId: string }> }) {
  ...
  return <AppShell context={context} surface="crm"><AppHeader context={context} eyebrow="Borrower CRM" title={borrower.legalName} /><BorrowerRelationshipSummary borrower={borrower} timezone={context.activeOrganization.timezone} /></AppShell>;
}
