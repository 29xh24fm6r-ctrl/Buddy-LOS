...
insert into public.organization_capability_activations(organization_id,capability_key,is_active,activated_at,activated_by,evidence_reference) values('22000000-0000-4000-8000-000000000001','underwriting_runtime',true,now(),'12000000-0000-4000-8000-000000000001','ci:underwriting-runtime');\ninsert into public.organization_product_modules(organization_id,module_key,status,activated_by) values('22000000-0000-4000-8000-000000000001','underwriting','active','12000000-0000-4000-8000-000000000001');
